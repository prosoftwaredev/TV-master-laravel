          ...
          <div class="chat-window-wrapper scroller scrollbar-dynamic" id="chat-users">
            ...
            <div class="side-widget fadeIn">
              ...
              <div id="favourites-list">
                <div class="side-widget-content">
                  <div class="user-details-wrapper active" data-chat-status="online" data-chat-user-pic="{{ Request::root() }}/assets/img/profiles/d.jpg" data-chat-user-pic-retina="{{ Request::root() }}/assets/img/profiles/d2x.jpg" data-user-name="Jane Smith">
